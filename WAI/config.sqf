if(isServer) then {
	...
	/* GENERAL CONFIG */
		...
		debug_mode				= false;	// enable debug keep false
	...
	/* AI CONFIG */
		...
		ai_clear_body 				= false;		// instantly clear gear from dead AI bodies
		ai_clean_dead 				= true;			// clear dead AI bodies after certain amount of time
		ai_cleanup_time 			= 7200;			// time to clear AI bodies after death in seconds
		ai_clean_roadkill			= false; 		// clean AI bodies that are run over by players
		ai_roadkill_damageweapon	= 0;			// percentage of chance runing over an AI will destroy the weapon the AI is carrying

		// I suggest leaving combatmode/behaviour alone
		...
		ai_share_distance			= 300;			// Distance from killed AI for AI to share your rough position with eachother

		// Humanity/stats 
		ai_kills_gain				= true;			// add kill to bandit/human kill score (on debug monitor)
		...
		ai_static_useweapon			= true;	// Allows AI on mounted guns to have a loadout
		ai_static_weapons			= ["KORD_high_TK_EP1","DSHKM_Ins","M2StaticMG"];	// Mounted guns

		ai_static_skills			= false;	// Allows you to set custom array for AI on static weapons. (true: On false: Off) 
		ai_static_array				= [["aimingAccuracy",0.20],["aimingShake",0.70],["aimingSpeed",0.75],["endurance",1.00],["spotDistance",0.70],["spotTime",0.50],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]];

		// AI gear sets, what they hold in their inventory
		...
		ai_add_skin					= true;	// adds unit skin to inventory on death, good for those without take clothes
	...
	/* WAI MISSIONS CONFIG */
		...
		wai_mission_timer			= [300,900];						// time between missions 5-15 minutes (set in seconds)
		...
		/*
		// These are missions that are for both hero and bandit.
		wai_special_missions		= [
										["bunny_ranch",100]
									];
		*/
		
		// Vehicle arrays, what vehicles can be spawned in which category
		...
		// Dynamic box arrays, what types of crates and what can spawn in them
	...
	/* STATIC MISSIONS CONFIG */
		...
		// Static missions are ones you create and set to spawn in a specific location at all times
		static_missions				= false;		// use static mission file
		custom_per_world			= false;		// use a custom mission file per world

	/* END STATIC MISSIONS CONFIG */

	configloaded = true; // LEAVE THIS ALONE!
